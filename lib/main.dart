...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  // Compiler ko clear rakhne ke liye helper function
  ...
  Future<void> _captureAndSave(String format) async {
    ...
    // UI hide hone ke liye proper wait
    ...
    try {
      if (format == 'JPG' || format == 'PNG') {
        ...
        // 🔥 TRUE VECTOR ENGINE (No image wrapper for text)
          ...
          pw.Page(
            ...
            build: (pw.Context context) {
              return pw.Container(
                width: size.width,
                height: size.height,
                color: _getPdfColor(pageColor),
                child: pw.Stack(
                  // Pura code clean rakha gaya hai (clipBehavior hamesha ke liye hata diya gaya hai)
                  children: elements.map((e) {
                        ...
                        child: pw.Container(
                          ...
                          child: pw.Container(
                            decoration: pw.BoxDecoration(
                              border: pw.Border.all(color: _getPdfColor(e.elementColor), width: e.borderWidth),
                    ...
                    if (e.isShape) {
                      contentWidget = pw.Container(
                        ...
                        decoration: pw.BoxDecoration(
                          color: _getPdfColor(e.elementColor),
                      ...
                      contentWidget = pw.SizedBox(
                        ...
                        child: pw.Text(
                          ...
                          style: pw.TextStyle(
                            font: customFont,
                            fontSize: e.fontSize,
                            color: _getPdfColor(e.textColor),
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Error: Kuch technical problem aayi hai.')));
      }
    } finally {
      setState(() {
        _isExporting = false; 
