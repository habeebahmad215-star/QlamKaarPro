...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  List<DesignPage> pages = [
    // Demo text ke liye default width 280 di hai taaki screen se bahar na jaye
                      ...
                      onPressed: () {
                        if (controller.text.isNotEmpty) {
                          ...
                          if (existingElement != null) {
                            ...
                            // Naya text add karte waqt automatically width 280 set hogi taaki wrap ho sake
  ...
  Future<void> addImageFromGallery() async {
    try {
      ...
      if (image != null) {
        final bytes = await image.readAsBytes(); saveState();
  ...
  void _toggleAlignment(DesignElement sel) {
    saveState(); setState(() { sel.textAlign = (sel.textAlign == TextAlign.right) ? TextAlign.center : (sel.textAlign == TextAlign.center ? TextAlign.left : TextAlign.right); });
  }
    ...
    showModalBottomSheet(
      ...
      builder: (context) => Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          const Text('Select Font (فونٹ)', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), const Divider(),
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [Container(margin: const EdgeInsets.symmetric(horizontal: 10, vertical: 8), padding: const EdgeInsets.symmetric(horizontal: 15), decoration: BoxDecoration(color: const Color(0xFF8B5CF6), borderRadius: BorderRadius.circular(8)), alignment: Alignment.center, child: const Text('Save Pro', style: TextStyle(color: Colors.white, fontWeight: FontWeight.bold)))],
      ),
          ...
          child: AspectRatio(
            ...
            child: Container(
              ...
              child: Stack(
                ...
                children: [
                  // 🔲 PRINT SAFE AREA (Red faint line)
                  Positioned.fill(
                    child: Container(
                      margin: const EdgeInsets.all(15), // Safe margin from edges
                  ...
                  ...elements.map((e) {
                    ...
                    if (e.isBorder) {
                      ...
                      // 📝 TEXT BOX WITH PROPER WRAPPING CONSTRAINT
                    ...
                    return Positioned(
                      ...
                      child: GestureDetector(
                        ...
                        child: isSel 
                          // 🔥 TEXT BOX SELECTION WITH WIDTH RESIZING HANDLES
                          ? Container(
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  // 👉 RIGHT RESIZE HANDLE (Width change karne ke liye)
                                  if (e.isText)
                                    Positioned(
                                      ...
                                      child: GestureDetector(
                                        onPanUpdate: (d) {
                                          setState(() {
                                            double w = (e.width > 0 ? e.width : 280.0) + d.delta.dx;
                                            if (w > 50) e.width = w; // Set new wrap width
                                          });
                                        },
                                        child: Container(
                                          width: 25, color: Colors.transparent, alignment: Alignment.center,
                                          child: Container(width: 8, height: 25, decoration: BoxDecoration(color: const Color(0xFF8B5CF6), borderRadius: BorderRadius.circular(10))),
                                        ),
                                      ),
                                    ),
                                  ...
                                  if (e.isText)
                                    Positioned(
                                      ...
                                      child: GestureDetector(
                                        onPanUpdate: (d) {
                                          setState(() {
                                            double newW = (e.width > 0 ? e.width : 280.0) - d.delta.dx;
                                            if (newW > 50) { e.width = newW; e.x += d.delta.dx; } // Shift pos and width
                                          });
                                        },
                                        child: Container(
                                          width: 25, color: Colors.transparent, alignment: Alignment.center,
