                        ...
                        child: Container(
                          ...
                          child: Stack(
                            ...
                            children: [
                              ...
                              // 🔥 100% FIXED LIVE DRAWING OVERLAY 🔥
                              if (_isDrawingMode)
                                Positioned.fill(
                                  child: Listener(
                                    behavior: HitTestBehavior.opaque, // Ye har touch ko pakad lega!
                                    onPointerDown: (e) {
                                      saveState();
                                      setState(() { _currentPath = [e.localPosition]; });
                                    },
                                    onPointerMove: (e) {
                                      setState(() { _currentPath = List.from(_currentPath)..add(e.localPosition); });
                                    },
                                    onPointerUp: (e) {
...
class DrawingPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // 🔥 Pura canvas stretch hone se bachaane ke liye scaling fix
    if (!isLive) {
      double maxX = 1.0;
      double maxY = 1.0;
      for (var p in path) {
