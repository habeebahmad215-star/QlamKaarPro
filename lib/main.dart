  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GestureDetector(
        ...
        child: Center(
          // 🔥 NEW: INTERACTIVE VIEWER FOR ZOOM & PAN 🔥
          child: InteractiveViewer(
            panEnabled: !hasSelection, // Allows canvas moving only when nothing is selected
            scaleEnabled: true,
            minScale: 0.2,
                    ...
                    child: Stack(
                      ...
                      children: [
                        ...
                        ...elements.map((e) {
                          ...
                          // 🔥 BORDER FIX (Gesture Outside, Rotate Inside)
                          if (e.isBorder) {
                          ...
                          // 🔥 WORKSPACE FIX (Gesture Outside, Rotate Inside)
                          return Positioned(
                            left: e.x, top: e.y,
                            child: GestureDetector(
                              onTap: () => setState(() => selectedId = e.id),
                              ...
                              onPanUpdate: (d) => setState(() { 
                                ...
                                e.x += d.delta.dx; 
                                e.y += d.delta.dy; 
                              }), // Now drags exactly with your finger!
                              child: Transform.rotate(
                                angle: e.angle,
                                alignment: Alignment.center, // Center point for rotation
                                child: isSel 
                                  ? Container(
