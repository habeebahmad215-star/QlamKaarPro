...
// ================= WORKSPACE ELEMENTS (STRICT MODELS) =================
class ProjectModel {
...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  final List<ColorFilter> _filters = [
    ...
    const ColorFilter.matrix(const <double>[0.2126, 0.7152, 0.0722, 0, 0, 0.2126, 0.7152, 0.0722, 0, 0, 0.2126, 0.7152, 0.0722, 0, 0, 0, 0, 0, 1, 0]), 
    const ColorFilter.matrix(const <double>[0.393, 0.769, 0.189, 0, 0, 0.349, 0.686, 0.168, 0, 0, 0.272, 0.534, 0.131, 0, 0, 0, 0, 0, 1, 0]), 
    const ColorFilter.matrix(const <double>[-1, 0, 0, 0, 255, 0, -1, 0, 0, 255, 0, 0, -1, 0, 255, 0, 0, 0, 1, 0]), 
  ];
                                  ...
                                  child: GestureDetector(
                                    ...
                                    onPanEnd: (d) {
                                      if (_currentPath.length > 1) {
                                        double minX = _currentPath[0].dx;
                                        double maxX = _currentPath[0].dx;
                                        double minY = _currentPath[0].dy;
                                        double maxY = _currentPath[0].dy;
