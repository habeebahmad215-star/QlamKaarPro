...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      // 🔥 NEW LAYOUT: Column se buttons upar (Left Side) aur Canvas niche
      body: Column(
        children: [
          // 🔥 CANVAS TOOLS BAR (LOCK & RESET ZOOM) - LEFT SIDE
          if (!_isExporting)
            Container(
                ...
                children: [
                  InkWell(
                    ...
                    child: Container(
                      ...
                      child: Icon(_isCanvasLocked ? Icons.lock : Icons.lock_open, color: _isCanvasLocked ? Colors.redAccent : Colors.black87, size: 18),
                    ),
                  ),
                  ...
                  InkWell(
                    ...
                    child: Container(
                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 8),
                      decoration: BoxDecoration(color: Colors.white, borderRadius: BorderRadius.circular(8), boxShadow: const [BoxShadow(color: Colors.black12, blurRadius: 4)]),
                      child: const Icon(Icons.zoom_out_map, color: Colors.black87, size: 18),
                    ),
                  ),
                ],
              ),
