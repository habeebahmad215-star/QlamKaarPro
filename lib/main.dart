...
class DesignElement {
  ...
  // 🔥 NEW PRO FEATURES: TEXT CURVE & BLEND MODES 🔥
  double textCurveRadius; // For Circular Text (0 means straight)
  int blendModeIndex; // For Image Blend Modes (0:Normal, 1:Multiply, 2:Screen, 3:Overlay)
  ...
  DesignElement({
    ...
    this.textCurveRadius = 0.0, this.blendModeIndex = 0, // Initialized new properties
...
// 🔥 NEW PRO FEATURE: CURVED TEXT WIDGET 🔥
class CurvedTextWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    // Reverse characters for RTL (Urdu) curving properly
    List<String> chars = text.characters.toList().reversed.toList();
    double totalAngle = chars.length * (0.1 + (letterSpacing * 0.02)); 
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: List.generate(chars.length, (index) {
          double angle = startAngle + index * (0.1 + (letterSpacing * 0.02));
          if(radius < 0) angle = -angle; // Curve upwards/downwards
          
          return Transform(
            transform: Matrix4.identity()
              ..translate(radius * sin(angle), -radius * cos(angle))
              ..rotateZ(radius > 0 ? angle : angle + pi),
            alignment: Alignment.center,
...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  // 🔥 NEW PRO FEATURE: TEXT CURVE MODAL 🔥
  ...
  // 🔥 NEW PRO FEATURE: BLEND MODE MODAL FOR IMAGES 🔥
                                ...
                                children: [
                                  ...
                                  ...elements.map((e) {
                                    ...
                                    if (e.isShape) {
                                      ...
                                      // 🔥 NEW PRO FEATURE: BLEND MODES ON IMAGE 🔥
                                      ...
                                      // 🔥 NEW PRO FEATURE: CURVED TEXT RENDER LOGIC 🔥
                                      Widget buildTextWidget(Color c, [List<Shadow>? shadow]) {
                                        TextStyle st = TextStyle(fontFamily: e.fontFamily, fontSize: e.fontSize, color: c, fontWeight: e.isBold ? FontWeight.bold : FontWeight.normal, height: e.lineHeight, wordSpacing: e.wordSpacing, shadows: shadow);
                                      ...
                                      if (e.hasStroke) {
                                        TextStyle stStroke = TextStyle(fontFamily: e.fontFamily, fontSize: e.fontSize, foreground: Paint()..style = PaintingStyle.stroke..strokeWidth = e.strokeWidth..color = e.strokeColor, fontWeight: e.isBold ? FontWeight.bold : FontWeight.normal, height: e.lineHeight, wordSpacing: e.wordSpacing);
                                      ...
                                      // Ensure Curved Text container is sized properly
          ...
          child: SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                // 🔥 NEW PRO BUTTON: BLEND MODES FOR IMAGES 🔥
