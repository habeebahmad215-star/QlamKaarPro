    ...
    return InkWell(
      onTap: () {
        if (isNewDesign) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text('$engText jald aa رہا ہے!')));
        }
      },
      child: Container(
                                  ...
                                  child: GestureDetector(
                                    ...
                                    onPanEnd: (d) {
                                      if (_currentPath.length > 1) {
                                        double minX = _currentPath.map((o) => o.dx).reduce((a, b) => min(a, b));
                                        double maxX = _currentPath.map((o) => o.dx).reduce((a, b) => max(a, b));
                                        double minY = _currentPath.map((o) => o.dy).reduce((a, b) => min(a, b));
                                        double maxY = _currentPath.map((o) => o.dy).reduce((a, b) => max(a, b));
                                        
                                        double pathW = max(maxX - minX, 20.0);
                                        double pathH = max(maxY - minY, 20.0);
                                    ...
                                    // Yeh transparent dabba aapki ungliyon ka jadoo pakdega
                                    child: Container(
