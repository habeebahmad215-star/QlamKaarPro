...
class DesignElement {
  ...
  // 🔥 NEW PRO FEATURES 🔥
  double cornerRadius; // For Shapes and Images
...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  // 🔥 PRO FEATURE: IMAGE & SHAPE RADIUS (گولائی) 🔥
                              ...
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  ...elements.map((e) {
                                    ...
                                    // 🔥 UNIVERSAL SHADOWS & STROKES LOGIC 🔥
                                    ...
                                    if (e.isShape) {
                                      contentWidget = Container(width: currentWidth, height: e.height > 20 ? e.height : 90, decoration: BoxDecoration(color: e.elementColor, boxShadow: boxShadows.isNotEmpty ? boxShadows : null, border: universalBorder, borderRadius: BorderRadius.circular(e.cornerRadius)));
                                    } else if (e.imageBytes != null) {
                                      Widget img = Image.memory(e.imageBytes!, width: currentWidth, fit: BoxFit.cover);
                                      ...
                                      contentWidget = Container(
                                        width: currentWidth, 
                                        height: e.isCircleCrop ? currentWidth : null, 
                                      ...
                                      if (e.textTextureBytes != null) { txt = TextureTextWrapper(textureBytes: e.textTextureBytes, child: txt); }
          ...
          child: SingleChildScrollView(
            ...
            child: Row(
              children: [
                ...
                // 🔥 UNIVERSAL STROKE & SHADOW BUTTONS FOR ALL ELEMENTS 🔥
