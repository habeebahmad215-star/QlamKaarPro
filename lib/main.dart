...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  // ==== EXPORT & SAVE LOGIC (VECTOR PDF MAGIC 🚀) ====
      ...
      builder: (context) => Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            _buildExportOption(Icons.picture_as_pdf, 'Save as Vector PDF', '100% Crisp Print Quality (No Blur)', Colors.red, () {
  ...
  Future<void> _captureAndSave(String format) async {
    ...
    try {
      ...
      if (format == 'JPG' || format == 'PNG') {
        ui.Image image = await boundary.toImage(pixelRatio: 4.0); // 4x Ultra HD Raster
        ...
        // 🔥 ASLI VECTOR PDF ENGINE YAHAN HAI 🔥
          ...
          pw.Page(
            ...
            build: (pw.Context context) {
              return pw.Container(
                width: size.width,
                height: size.height,
                color: PdfColor(pageColor.red / 255, pageColor.green / 255, pageColor.blue / 255, pageColor.opacity),
                child: pw.Stack(
                        ...
                        child: pw.Container(
                          decoration: pw.BoxDecoration(
                            border: pw.Border.all(
                              color: PdfColor(e.elementColor.red / 255, e.elementColor.green / 255, e.elementColor.blue / 255, e.elementColor.opacity),
                              width: e.borderWidth
                            ),
                      ...
                      contentWidget = pw.SizedBox(
                        ...
                        child: pw.Text(
                          ...
                          style: pw.TextStyle(
                            font: customFont,
                            fontSize: e.fontSize,
                            color: PdfColor(e.textColor.red / 255, e.textColor.green / 255, e.textColor.blue / 255, e.textColor.opacity),
      ...
      body: GestureDetector(
        ...
        child: Center(
          child: AspectRatio(
            ...
            // 🔴 FIX: Box shadow & margin bahar kar diya taaki wo RepaintBoundary me capture na ho
            child: Container(
              ...
              child: RepaintBoundary(
                key: _canvasKey,
                child: Container(
                  color: pageColor, // Asli Canvas Background
                  child: Stack(
                    clipBehavior: Clip.none,
                    children: [
                      // 🔴 SAFE AREA GAYAB HONE WALA LOGIC
                      if (!_isExporting)
                        Positioned.fill(
                          child: Container(
                      ...
                      ...elements.map((e) {
                        ...
                        // 🔴 Export karte waqt exact same placement
                        if (_isExporting) {
                          return Positioned(
                            left: e.x, top: e.y,
                                            ...
                                            child: Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  ...
                                                  Inkങ്ക്Well(onTap: sendBackward, child: const Icon(Icons.arrow_downward, size: 20, color: Colors.black54)), const SizedBox(width: 15),
