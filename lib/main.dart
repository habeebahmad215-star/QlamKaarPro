...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  // ==== COLOR PICKER MODAL (NAYA FEATURE) ====
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            ...
                            setModalState((){}); // Update checkmark
                          },
                          child: Container(
                                ...
                                children: [
                                  ...
                                  if (e.isText)
                                    Positioned(
                                      ...
                                      child: GestureDetector(
                                        onPanUpdate: (d) { setState(() { double w = (e.width > 0 ? e.width : 280.0) + d.delta.dx; if (w > 50) e.width = w; }); },
                                        child: Container(width: 25, color: Colors.transparent, alignment: Alignment.center, child: Container(width: 8, height: 25, decoration: BoxDecoration(color: const Color(0xFF8B5CF6), borderRadius: BorderRadius.circular(10)))),
                                      ),
                                    ),
                                  ...
                                  if (e.isText)
                                    Positioned(
                                      ...
                                      child: GestureDetector(
                                        onPanUpdate: (d) { setState(() { double newW = (e.width > 0 ? e.width : 280.0) - d.delta.dx; if (newW > 50) { e.width = newW; e.x += d.delta.dx; } }); },
                                        child: Container(width: 25, color: Colors.transparent, alignment: Alignment.center, child: Container(width: 8, height: 25, decoration: BoxDecoration(color: const Color(0xFF8B5CF6), borderRadius: BorderRadius.circular(10)))),
                                      ),
                                    ),
        ...
        Padding(
          ...
          child: Row(
            children: [
              ...
              // 🔴 NAYA COLOR MODAL CALL HO RAHA HAI YAHAN 🔴
