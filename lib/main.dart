...
class DesignPage {
  ...
  Uint8List? bgImageBytes; // 🔥 NEW: BG Image Property
  
  DesignPage({required this.title, required this.elements, required this.pageColor, this.bgImageBytes});
  ...
  factory DesignPage.fromJson(Map<String, dynamic> json) => DesignPage(
    ...
    bgImageBytes: json['bgImageBytes'] != null ? base64Decode(json['bgImageBytes']) : null,
...
class DesignElement {
  ...
  // 🔥 NEW: LAYER MANAGEMENT PROPERTIES 🔥
  bool isLocked; bool isHidden; 
  ...
  DesignElement({
    ...
    this.isLocked = false, this.isHidden = false, // defaults
  ...
  factory DesignElement.fromJson(Map<String, dynamic> json) => DesignElement(
    ...
    isLocked: json['isLocked'] ?? false, isHidden: json['isHidden'] ?? false,
...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  // 🔥 NEW PRO FEATURE: Pick Background Image
  Future<void> _pickBgImage() async { try { final XFile? image = await _picker.pickImage(source: ImageSource.gallery); if (image != null) { final bytes = await image.readAsBytes(); saveState(); setState(() => bgImage = bytes); } } catch (e) {} }
  ...
  // 🔥 PRO FEATURE: ADVANCED LAYERS PANEL (LOCK & HIDE) 🔥
          ...
          Expanded(child: elements.isEmpty ? const Center(child: Text('No elements yet.', style: TextStyle(color: Colors.grey))) : ListView.builder(itemCount: elements.length, itemBuilder: (context, index) { 
            ...
            return Card(
              ...
              child: ListTile(
                ...
                title: Text(e.isText ? e.content.replaceAll('\n', ' ') : (e.isBorder ? e.content : 'Shape'), maxLines: 1, overflow: TextOverflow.ellipsis, style: TextStyle(decoration: e.isHidden ? TextDecoration.lineThrough : null, color: e.isHidden ? Colors.grey : Colors.black)), 
                      ...
                      child: RepaintBoundary(
                        ...
                        child: Container(
                          ...
                          child: Stack(
                            ...
                            children: [
                              // 🔥 NEW PRO FEATURE: CANVAS BACKGROUND IMAGE 🔥
                              if (bgImage != null)
                                Positioned.fill(
                              ...
                              ...elements.map((e) {
                                ...
                                if (e.isBorder) {
                                  return Positioned.fill(
                                    child: GestureDetector(
                                      // Only select if not locked
                                      onTap: e.isLocked ? null : () => setState(() => selectedId = e.id), 
                                      child: Transform(
                                ...
                                return Positioned(
                                  left: e.x, top: e.y,
                                  child: GestureDetector(
                                    // 🔥 PRO FEATURE: LAYER LOCKING PREVENTION 🔥
                                    onTap: e.isLocked ? null : () => setState(() => selectedId = e.id),
                                    onPanStart: e.isLocked ? null : (d) => saveState(),
                                    onPanUpdate: e.isLocked ? null : (d) => setState(() { selectedId = e.id; e.x += d.delta.dx; e.y += d.delta.dy; }),
                                    child: Transform(
                                      transform: matrix, alignment: Alignment.center,
                                      child: isSel 
                                        ? Padding(
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  _buildToolBtn(Icons.aspect_ratio, 'Resize', () {}), 
