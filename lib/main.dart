...
class DesignElement {
  ...
  // 🔥 NEW PRO FEATURES 🔥
  int clipShape; // 0:None, 1:Circle, 2:Triangle, 3:Star, 4:Hexagon
  bool isTinted; // For PNG Color Changing
  Color? customGradColor1; Color? customGradColor2; // Custom Gradient Builder
  ...
  factory DesignElement.fromJson(Map<String, dynamic> json) {
    ...
    if (json['isCircleCrop'] == true) loadedClipShape = 1; // Backward compatibility
...
class _TextureTextWrapperState extends State<TextureTextWrapper> {
  ...
  @override Widget build(BuildContext context) { if (_image == null || widget.textureBytes == null) return widget.child; return ShaderMask(blendMode: BlendMode.srcATop, shaderCallback: (bounds) { final matrix = Matrix4.identity(); matrix.scale(bounds.width / _image!.width, bounds.height / _image!.height); return ImageShader(_image!, TileMode.clamp, TileMode.clamp, matrix.storage); }, child: widget.child); }
}
...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  Future<void> _setCanvasBackground() async { try { final XFile? image = await _picker.pickImage(source: ImageSource.gallery); if (image != null) { final bytes = await image.readAsBytes(); setState(() => bgImageBytes = bytes); } } catch (e) { debugPrint("BG Image Error: $e"); } }
  ...
  // 🔥 PRO FEATURE: CUSTOM GRADIENT BUILDER 🔥
  ...
  // 🔥 PRO FEATURE: ADVANCED SHAPE CLIPPING MODAL 🔥
                          ...
                          child: RepaintBoundary(
                            ...
                            child: Container(
                              ...
                              decoration: bgImageBytes != null 
                                  ...
                                  : (pageColor == Colors.transparent ? const BoxDecoration(image: DecorationImage(image: AssetImage('assets/transparent_pattern.png'), repeat: ImageRepeat.repeat)) : null),
                              child: Stack(
                                ...
                                children: [
                                  ...
                                  ...elements.map((e) {
                                    ...
                                    if (e.isShape) {
                                      ...
                                      // 🔥 NEW PRO FEATURE: IMAGE TINTING (Color Change for PNGs) 🔥
                                      if (e.isTinted) {
                                      ...
                                      // 🔥 NEW PRO FEATURE: ADVANCED CLIPPING SHAPES 🔥
                                      if (e.clipShape == 1) {
            ...
            child: SingleChildScrollView(
              ...
              child: Row(
                children: [
                  ...
                  _buildToolBtn(Icons.layers_clear, 'Clear BG', () { saveState(); setState((){ pageColor = Colors.transparent; bgImageBytes = null; }); }), 
                  _buildToolBtn(Icons.format_color_fill, 'BG Color', () { saveState(); setState((){ pageColor = pageColor == Colors.white ? Colors.amber.shade100 : Colors.white; bgImageBytes = null; }); }),
                ],
              ),
            ),
          ),
