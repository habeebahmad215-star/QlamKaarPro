...
class DesignElement {
  ...
  DesignElement({
    ...
    this.textBgColor, this.textBgRadius = 10.0, this.wordSpacing = 0.0, this.textGradient,
  });
...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  // 🔥 THE ULTIMATE 50+ DESIGNER COLOR PALETTE 🔥
  final List<Color> _proColorPalette = [
    ...
    // Greens (Madrasa Specials)
    const Color(0xFF004d00), // Very Dark Green
    const Color(0xFF14532D), // Deep Emerald
    ...
    const Color(0xFFFAEBD7), // Navajo White
  ];

  // 🔥 THE VIP 20+ GRADIENT PALETTE 🔥
  final List<List<Color>> _proGradientPalette = [
    // Metallics
    [const Color(0xFFBF953F), const Color(0xFFFCF6BA), const Color(0xFFB38728), const Color(0xFFFBF5B7)], // Premium Gold
    [const Color(0xFF8E9EAB), const Color(0xFFEEF2F3)], // Silver
    [const Color(0xFFB87333), const Color(0xFFFFCC99), const Color(0xFFB87333)], // Bronze
    [const Color(0xFFB76E79), const Color(0xFFE0BFB8)], // Rose Gold
    // Nature
    [const Color(0xFFFF4E50), const Color(0xFFF9D423)], // Fire
    [const Color(0xFF1A2980), const Color(0xFF26D0CE)], // Aqua
    [const Color(0xFF134E5E), const Color(0xFF71B280)], // Forest
    [const Color(0xFFFF7E5F), const Color(0xFFFEB47B)], // Sunset
    [const Color(0xFF2C3E50), const Color(0xFF3498DB)], // Midnight Sky
    // Vibrant / Neon
    [const Color(0xFF833AB4), const Color(0xFFFD1D1D), const Color(0xFFFCB045)], // Instagram
    [const Color(0xFF12C2E9), const Color(0xFFC471ED), const Color(0xFFF64F59)], // Joda
    [const Color(0xFF00C9FF), const Color(0xFF92FE9D)], // Sea Weed
    [const Color(0xFFF09819), const Color(0xFFEDDE5D)], // Sunrise
    [const Color(0xFFDA22FF), const Color(0xFF9733EE)], // Purple Neon
    [const Color(0xFFEC008C), const Color(0xFFFC6767)], // Pink Neon
    [const Color(0xFF02AAB0), const Color(0xFF00CDAC)], // Green Beach
    // Dark & Elegant
    [const Color(0xFF434343), const Color(0xFF000000)], // Pure Black
    [const Color(0xFF0F2027), const Color(0xFF203A43), const Color(0xFF2C5364)], // Deep Space
    [const Color(0xFF141E30), const Color(0xFF243B55)], // Royal Navy
    [const Color(0xFF870000), const Color(0xFF190A05)], // Dark Blood
  ];
  ...
  void _showGradientPickerModal(DesignElement sel) {
    showModalBottomSheet(context: context, backgroundColor: Colors.white, shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))), builder: (context) { return StatefulBuilder(builder: (context, setModalState) { return Container(height: 450, padding: const EdgeInsets.all(20), child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('Gradient Text (ملٹی کلر)', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), IconButton(icon: const Icon(Icons.close), onPressed: () => Navigator.pop(context))]), const Divider(), 
      ListTile(leading: const Icon(Icons.block), title: const Text('Clear Gradient (سادہ رنگ)'), onTap: () { saveState(); setState(() { sel.textGradient = null; }); Navigator.pop(context); }),
    ...
    showModalBottomSheet(context: context, backgroundColor: Colors.white, shape: const RoundedRectangleBorder(borderRadius: BorderRadius.vertical(top: Radius.circular(20))), builder: (context) { 
      return StatefulBuilder(builder: (context, setModalState) { 
        return Container(height: 250, padding: const EdgeInsets.all(20), child: Column(children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('Spacing (فاصلہ)', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), IconButton(icon: const Icon(Icons.close), onPressed: () => Navigator.pop(context))]), 
