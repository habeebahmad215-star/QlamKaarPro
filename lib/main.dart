...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  // 🔴 YAHAN NAYA VARIABLE HAI SAFE AREA CHHUPANE KE LIYE
  ...
  Future<void> _captureAndSave(String format) async {
    // 1. Safe Area aur Selection Box dono hide karein
    setState(() {
      selectedId = null;
      _isExporting = true; // Isse Safe Area gayab ho jayega
    });
    
    // 2. Refresh hone ka wait
    await Future.delayed(const Duration(milliseconds: 300));
    
    try {
      // 3. HD Screenshot nikalna
      ...
      if (format == 'JPG' || format == 'PNG') {
        ...
        pdf.addPage(
          pw.Page(
            ...
            build: (pw.Context context) {
              return pw.Center(child: pw.Image(imagePdf)); // Image ko PDF mein daal diya
            },
          ),
        );
        ...
        // Natively Save ya Share karne ka menu khulega
      ...
      // 5. Save hone ke baad wapas Safe Area dikhayein
      setState(() {
        _isExporting = false; 
      });
    }
            ...
            child: RepaintBoundary(
              ...
              child: Container(
                ...
                child: Stack(
                  ...
                  children: [
                    // 🔴 YAHAN LOGIC LAGAYA HAI TAAKI SAVE KE WAQT SAFE AREA CHHUP JAYE
                    if (!_isExporting)
                      Positioned.fill(
                        child: Container(
