                          ...
                          child: Stack(
                            ...
                            children: [
                              ...
                              ...elements.map((e) {
                                ...
                                if (e.isPath && e.drawPath != null) {
                                  contentWidget = SizedBox(
                                    width: currentWidth,
                                    height: e.height > 20 ? e.height : 50,
                                    child: CustomPaint(
                              ...
                              if (_isDrawingMode)
                                Positioned.fill(
                                  child: GestureDetector(
                                    behavior: HitTestBehavior.opaque, // <--- Ye touch pakdega!
                                    onPanStart: (d) {
                                      saveState(); 
                                    ...
                                    onPanUpdate: (d) {
                                      setState(() {
                                        _currentPath = List.from(_currentPath)..add(d.localPosition); // <--- Ye screen update karega!
                                      });
                                    },
                                    onPanEnd: (d) {
                                      if (_currentPath.length > 1) {
                                        ...
                                        setState(() {
                                          elements.add(DesignElement(
                                            ...
                                            width: max(maxX - minX, 20.0), height: max(maxY - minY, 20.0)
                                          ));
                                          _currentPath = [];
                                        });
                                      }
