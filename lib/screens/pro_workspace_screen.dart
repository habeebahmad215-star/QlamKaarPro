...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
                        ...
                        children: [
                          GestureDetector(
                            ...
                            child: Container(
                              ...
                              child: Text('English', style: TextStyle(fontWeight: !isRTL ? FontWeight.bold : FontWeight.normal, color: !isRTL ? Colors.black : Colors.grey))
                            ),
                          ),
                          GestureDetector(
                            ...
                            child: Container(
                              padding: const EdgeInsets.symmetric(horizontal: 24, vertical: 12),
                              decoration: BoxDecoration(color: isRTL ? Colors.white : Colors.transparent, borderRadius: BorderRadius.circular(25), boxShadow: isRTL ? [const BoxShadow(color: Colors.black12, blurRadius: 4)] : []),
                              child: Text('اردو', style: TextStyle(fontWeight: isRTL ? FontWeight.bold : FontWeight.normal, color: isRTL ? Colors.black : Colors.grey))
                            ),
                          ),
                        ],
                      ),
            ...
            Expanded(
              child: GridView.builder(
                ...
                itemBuilder: (ctx, index) {
                  return InkWell(
                    onTap: () {
                      if(colorNum == 1) sel.customGradColor1 = expandedColors[index];
                      else sel.customGradColor2 = expandedColors[index];
                      parentSetState((){});
                      _triggerCanvasUpdate();
                      Navigator.pop(ctx);
                    },
                    child: Container(decoration: BoxDecoration(color: expandedColors[index], shape: BoxShape.circle, border: Border.all(color: Colors.grey.shade300)))
                  );
                }
              )
            )
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        const Text("Make Your Own", style: TextStyle(fontWeight: FontWeight.bold)),
                        const SizedBox(height: 10),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.spaceEvenly,
                          children: [
          ...
          builder: (context, setModalState) {
            return Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('3D Block/Depth', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), IconButton(icon: const Icon(Icons.close), onPressed: () => Navigator.pop(context))]),
                  const Divider(),
        ...
        return StatefulBuilder(
          builder: (context, setModalState) {
            return Container(
              ...
              child: Column(
                children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('Corner Radius', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), IconButton(icon: const Icon(Icons.close), onPressed: () => Navigator.pop(context))]),
          ...
          builder: (context, setModalState) {
            return Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('Crop to Shape', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), IconButton(icon: const Icon(Icons.close), onPressed: () => Navigator.pop(context))]),
                  const Divider(),
                  Expanded(
                    child: ListView(
                      scrollDirection: Axis.horizontal,
          ...
          builder: (context, setModalState) {
            return Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('Image Filters', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), IconButton(icon: const Icon(Icons.close), onPressed: () => Navigator.pop(context))]),
                  const Divider(),
                  Expanded(
                    child: ListView(
                      scrollDirection: Axis.horizontal,
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(children: [const Text('Letter:', style: TextStyle(fontWeight: FontWeight.bold, color: Colors.grey)), Expanded(child: Slider(value: sel.letterSpacing.clamp(-5.0, 30.0), min: -5.0, max: 30.0, activeColor: const Color(0xFF8B5CF6), onChanged: (val) { setState(()=> sel.letterSpacing = val); setModalState((){}); _triggerCanvasUpdate();}))])
                ]
              )
            );
          }
            ...
            return Container(
              ...
              child: Column(
                children: [
                  ...
                  Slider(value: sel.fontSize.clamp(10.0, 250.0), min: 10.0, max: 250.0, activeColor: const Color(0xFF8B5CF6), onChangeStart: (val) => saveState(), onChanged: (val) { setState(() => sel.fontSize = val); setModalState((){}); _triggerCanvasUpdate(); })
                ]
              )
            );
          }
        ...
        return StatefulBuilder(
          builder: (context, setModalState) {
            return Container(
              ...
              child: Column(
                children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('3D Perspective', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), IconButton(icon: const Icon(Icons.close), onPressed: () => Navigator.pop(context))]),
                  const SizedBox(height: 10),
        ...
        return StatefulBuilder(
          builder: (context, setModalState) {
            ...
            return Container(
              ...
              child: Column(
                children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('Nudge Tool', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), IconButton(icon: const Icon(Icons.close), onPressed: () => Navigator.pop(context))]),
                  const SizedBox(height: 10),
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [IconButton(icon: const Icon(Icons.arrow_upward, size: 35, color: const Color(0xFF8B5CF6)), onPressed: () => move(0, -5))]),
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [IconButton(icon: const Icon(Icons.arrow_back, size: 35, color: const Color(0xFF8B5CF6)), onPressed: () => move(-5, 0)), const SizedBox(width: 40), IconButton(icon: const Icon(Icons.arrow_forward, size: 35, color: const Color(0xFF8B5CF6)), onPressed: () => move(5, 0))]),
                  Row(mainAxisAlignment: MainAxisAlignment.center, children: [IconButton(icon: const Icon(Icons.arrow_downward, size: 35, color: const Color(0xFF8B5CF6)), onPressed: () => move(0, 5))]),
                ]
              )
            );
          }
        ...
        return StatefulBuilder(
          builder: (context, setModalState) {
            return Container(
              ...
              child: Column(
                children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('Curve Text', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), IconButton(icon: const Icon(Icons.close), onPressed: () => Navigator.pop(context))]),
                  const SizedBox(height: 10),
          ...
          builder: (context, setModalState) {
            return Container(
              ...
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('Blend Modes', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)), IconButton(icon: const Icon(Icons.close), onPressed: () => Navigator.pop(context))]),
                  const Divider(),
                  Expanded(
          ...
          child: Column(
            ...
            children: [
              ...
              Expanded(
                child: ListView(
                  children: [
                    ListTile(leading: const Icon(Icons.crop_square), title: const Text('1:1 (Square/Logo)'), onTap: () { saveState(); setState(() => canvasRatio = 1.0); _triggerCanvasUpdate(); Navigator.pop(context); }),
                    ListTile(leading: const Icon(Icons.crop_16_9), title: const Text('16:9 (YouTube)'), onTap: () { saveState(); setState(() => canvasRatio = 16/9); _triggerCanvasUpdate(); Navigator.pop(context); }),
                    ...
                    ListTile(leading: const Icon(Icons.description), title: const Text('1:1.414 (A4 Print)'), onTap: () { saveState(); setState(() => canvasRatio = 1/1.414); _triggerCanvasUpdate(); Navigator.pop(context); }),
                  ]
                )
              )
            ]
                    ...
                    child: ListView(
                      ...
                      children: [
                        const Padding(
                          ...
                          child: Text('Pre-installed Fonts', style: TextStyle(fontWeight: FontWeight.bold))
                        ),
                        ...
                        if (customFonts.isNotEmpty) ...[
                          const Padding(
                            ...
                            child: Text('Custom Fonts', style: TextStyle(fontWeight: FontWeight.w900, color: Colors.black))
                          ),
  ...
  Widget _buildSelectedToolBar(DesignElement sel) {
    ...
    topRow.add(_buildToolBtn(Icons.opacity, 'Opacity', () { 
