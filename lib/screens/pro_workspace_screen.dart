...
class _ProWorkspaceScreenState extends State<ProWorkspaceScreen> {
  ...
  void _toggleAlignment(DesignElement sel) {
    saveState();
    setState(() { if (sel.textAlign == TextAlign.right) { sel.textAlign = TextAlign.center; } else if (sel.textAlign == TextAlign.center) { sel.textAlign = TextAlign.left; } else { sel.textAlign = TextAlign.right; } });
    _triggerCanvasUpdate();
  }
