                                  ...
                                  ...elements.map((e) {
                                    ...
                                    return Positioned(
                                      ...
                                      child: GestureDetector(
                                        ...
                                        // 🔥 GROUPING + SNAPPING MOVEMENT LOGIC 🔥
                                        onPanUpdate: (d) {
                                          if(!e.isLocked) {
                                            setState(() { 
                                              selectedId = e.id; 
