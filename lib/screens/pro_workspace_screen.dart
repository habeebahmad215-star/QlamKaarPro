      ...
      body: Expanded(
        child: Stack(
          children: [
            ...
            // 🔥 FIX 1: TUCKED-AWAY CANVAS LOCK ICON (Top Left, Safe Zone) 🔥
            if (!_isExporting)
              Positioned(
                top: 10,
                left: 10,
            ...
            // 🔥 FIX 2 & 3: AUTO-HIDING SMART ZOOM HUD (Top Center) 🔥
            if (!_isExporting)
              Positioned(
                top: 10,
                left: 0,
                ...
                child: ValueListenableBuilder<double>(
                  ...
                  builder: (context, zoom, child) {
                    // Logic: Agar zoom exactly 1.0 ke aas-paas hai, toh chhup jao.
                          ...
                          child: BackdropFilter(
                            ...
                            child: Container(
                              ...
                              child: InkWell(
                                onTap: () {
                                  HapticFeedback.selectionClick();
                                  _transformController.value = Matrix4.identity(); // 1-Tap Reset
                                },
                                child: Row(
                                  mainAxisSize: MainAxisSize.min,
                                  children: [
